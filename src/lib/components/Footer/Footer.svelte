	...
	>
		...
		>
			<div class="flex flex-col gap-2 text-center [@media(min-width:650px)]:text-left">
				...
				<a
					href="https://www.youtube.com/@thehenriktoth"
					class="text-xs [@media(min-width:640px)]:text-sm">YouTube</a
				>
				<a
					href="https://www.tiktok.com/@thehenriktoth"
					class="text-xs [@media(min-width:640px)]:text-sm">TikTok</a
				>
			</div>
			<div class="flex flex-col gap-2 text-center [@media(min-width:650px)]:text-left">
				<p class="text-sm font-bold [@media(min-width:640px)]:text-base">
				...
				<a href={`${base}/`} class="text-xs [@media(min-width:640px)]:text-sm">{$_('nav.home')}</a>
				<a href={`${base}/apps`} class="text-xs [@media(min-width:640px)]:text-sm"
					>{$_('nav.apps')}</a
				>
				<a href={`${base}/blog`} class="text-xs [@media(min-width:640px)]:text-sm"
					>{$_('nav.blog')}</a
				>
				<a href={`${base}/contact`} class="text-xs [@media(min-width:640px)]:text-sm"
					>{$_('nav.contact')}</a
				>
			</div>
		</div>
